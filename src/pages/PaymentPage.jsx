...
export default function PaymentPage() {
    ...
    useEffect(() => {
        if (isLoggedIn) {
            ...
            fetch("http://3.34.4.126:9000/member/userinfo", {
                method: "GET",
                headers: {
    ...
    const handleCreditCardPayment = async (orderData) => {
        ...
        try {
            const response = await axios.post(
                "http://3.34.4.126:9000/order/checkout",
                orderData
            );
    ...
    const handleKakaoPayPayment = async (orderData) => {
        ...
        try {
            const res = await axios.post("http://3.34.4.126:9000/payment/qr", {
                id: id,
                item_name: "테스트 상품",
    ...
    const handleKakaoPayApprove = async (pgToken) => {
        ...
        try {
            const res = await axios.post("http://3.34.4.126:9000/payment/approve", {
                pg_token: pgToken,
                tid,
                id,
                total_amount: totalPrice,
